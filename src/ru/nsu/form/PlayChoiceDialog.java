...
public class PlayChoiceDialog extends JDialog {
    ...
    public PlayChoiceDialog(JLabel playLabel) {
    ...
    private void onOK() {
        ...
        playLabel.setText(chosen.getName());
        RoleController.updateRoleTable(chosen.getId());
        dispose();
    }
